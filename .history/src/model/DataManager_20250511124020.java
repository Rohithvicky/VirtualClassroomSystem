...
public class DataManager {
    ...
    // Get quizzes with proper object handling
    ...
    // Get assignments with proper object handling
    ...
    // Get quiz ID by title (duplicate removed)
    ...
    // Get all quizzes (as string list)
    ...
    // Get all assignments (as string list)
