...
public class DataManager {
    ...
    public Quiz getQuiz(String quizTitle) {
        ...
        // Iterate over the list obtained from the database and return the matching quiz
    ...
    public List<String[]> getQuizQuestions(String quizTitle) {
        int quizId = getQuizIdByTitle(quizTitle);
        if (quizId == -1) {
            return new ArrayList<>(); // Return empty list if quiz not found
        }
        return getQuizQuestions(quizId);
    }

    // Get all classes as a list of strings for display
    ...
    // Get all quizzes (as a display string list)
    ...
    // Get quizzes for a specific student (as a display string list)
    ...
    // Get all assignments (as a display string list)
    ...
    // Get assignments for a specific student (as a display string list)
    ...
    // Take a quiz by adding a record into quiz_attempts
    ...
    // Attend a class by adding a record into attendance
    ...
    // Submit an assignment by adding a record into submissions
    ...
    // Add an assignment with a description (if classId is -1, exclude class_id
    // field)
