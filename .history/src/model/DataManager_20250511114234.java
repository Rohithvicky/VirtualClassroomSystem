...
public class DataManager {
    ...
    public Quiz getQuiz(String quizTitle) {
        ...
        try {
            ...
            if (rs.next()) {
                // Fix constructor call to match the Quiz class definition
                return new Quiz(
                        rs.getString("title"),
    ...
    // Get quiz questions for a given quiz ID
    ...
    // NEW METHOD: Get quiz questions by quiz title (converts title to ID)
