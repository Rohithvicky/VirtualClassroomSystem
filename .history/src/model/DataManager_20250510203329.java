...
public class DataManager {
    ...
    public boolean addQuiz(String title, String question, String optionA, String optionB, String optionC, String optionD, String correctAnswer) {
    ...
    public Quiz getQuiz(String title) {
        // Fetch the quiz from the database or a file
        // Example: Retrieve from a database table or JSON file
        return new Quiz(title, "Sample Question?", "Option A", "Option B", "Option C", "Option D", "A");
    }
    ...
    public List<String> getQuizzes() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, 
                "Database error when fetching quizzes: " + e.getMessage(), 
                "Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        } finally {
            try {
