...
public class DataManager {
    ...
    // Add a quiz to the database (for meta-data)
    ...
    // Add a quiz question to the database (using a separate table: quiz_questions)
    public boolean addQuizQuestion(String quizTitle, String question, String optionA, String optionB, String optionC,
        ...
        try {
            conn = DBConnection.getConnection();
            // Adjusted to use the quiz_questions table and include the quizTitle as a
            // foreign key
    ...
    // Get quiz questions for a given quiz title from the quiz_questions table
    public List<String[]> getQuizQuestions(String quizTitle) {
        ...
        try {
            conn = DBConnection.getConnection();
            // Adjusted query to use the quiz_questions table instead of quizzes
            ...
            while (rs.next()) {
                ...
                // Add the question and options as an array
    ...
    // Modified method to match the call in StudentDashboard.java
