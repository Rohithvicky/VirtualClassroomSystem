...
public class Assignment {
    ...
    /**
     * Overloaded constructor to initialize Assignment with id, title, and dueDate.
     * The dueDate is converted to a Timestamp representing the start of that day.
     *
     * @param id      the assignment ID
     * @param title   the assignment title
     * @param dueDate the due date for the assignment as a LocalDate
     */
    public Assignment(int id, String title, LocalDate dueDate) {
        this.id = id;
        this.title = title;
        // Convert LocalDate to Timestamp at the start of the day
