    ...
    private JPanel createDashboardPanel() {
        ...
        JPanel statsPanel = new JPanel(new GridLayout(1, 3, 20, 20)) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gradient = new GradientPaint(0, 0, new Color(240, 248, 255), getWidth(), getHeight(), new Color(220, 235, 250));
        ...
        statsPanel.add(createRoundedStatCard("Assignments", String.valueOf(assignmentListModel.size()), new Color(255, 152, 0))); // Orange
