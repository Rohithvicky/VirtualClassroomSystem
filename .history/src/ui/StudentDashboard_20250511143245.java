...
public class StudentDashboard extends JFrame {
    ...
    private void loadData() {
        ...
        // Load classes if available (fix: add if DataManager provides such data)
        if (dm.getClassesObj() != null) {
            dm.getClassesObj().forEach(cls -> classListModel.addElement(cls.getDisplayTitle()));
        }
