...
public class RegisterPage extends JFrame {
  ...
  public RegisterPage() {
    ...
    // Username Field with additional left margin for separation
    gbc.gridx = 1;
    ...
    // Password Field with left margin for separation
    gbc.gridx = 1;
    gbc.insets = new Insets(10, 30, 10, 10);
    ...
    // Row for Create Account button spanning two columns
    gbc.gridy++;
    JButton registerButton = new JButton("Create Account");
    registerButton.setFont(new Font("Segoe UI", Font.BOLD, 16));
    registerButton.setBackground(new Color(41, 128, 185)); // fully blue button
    ...
    // Add the header, form and footer panels to main panel
