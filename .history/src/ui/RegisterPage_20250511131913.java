...
public class RegisterPage extends JFrame {
  ...
  public RegisterPage() {
    ...
    // If you don't have a logo yet, use a text placeholder
    if (getClass().getResource("/resources/logo.png") == null) {
      logoLabel = new JLabel("Quick Mart");
    ...
    loginLink.addMouseListener(new MouseAdapter() {
      ...
      public void mouseEntered(MouseEvent e) {
        ...
        Map<TextAttribute, Object> attributes = font.getAttributes();
