...
/**
 * AssignmentPanel provides the UI for viewing, uploading, and managing
 * assignments
 * in the Virtual Classroom System.
 */
public class AssignmentPanel extends JPanel {
    // Constants for table columns and layout
    ...
    /**
     * Set up the layout of components using panels.
     */
    ...
    /**
     * Load assignments from the database without filter.
     */
    ...
    private void loadAssignments(String filter) {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            StringBuilder sqlBuilder = new StringBuilder(
                    "SELECT a.*, u.username FROM assignments a LEFT JOIN users u ON a.uploaded_by = u.id");
            if (filter != null) {
