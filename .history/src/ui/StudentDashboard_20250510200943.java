...
public class StudentDashboard extends JFrame {
    ...
    private void updateDashboardPanel() {
        ...
        statsPanel.add(createRoundedStatCard("Classes", String.valueOf(classCount), new Color(76, 175, 80))); // Green
        statsPanel.add(createRoundedStatCard("Quizzes", String.valueOf(quizCount), new Color(33, 150, 243))); // Blue
        statsPanel.add(createRoundedStatCard("Assignments", String.valueOf(assignmentCount), new Color(255, 152, 0))); // Orange
