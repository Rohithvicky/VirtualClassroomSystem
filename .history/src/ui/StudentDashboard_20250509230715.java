...
public class StudentDashboard extends JFrame {
    ...
    private JPanel createDashboardPanel() {
        ...
        statsPanel.setBackground(new Color(245, 245, 245)); // Match background
        statsPanel.setBorder(BorderFactory.createEmptyBorder(20, 0, 0, 0));

        // Add stat cards
        statsPanel.add(createStatCard("Classes", String.valueOf(classListModel.size()), new Color(102, 187, 106))); // Green
        statsPanel.add(createStatCard("Quizzes", String.valueOf(quizListModel.size()), new Color(66, 165, 245))); // Blue
        statsPanel.add(createStatCard("Assignments", String.valueOf(assignmentListModel.size()), new Color(255, 183, 77))); // Orange
    ...
    private JPanel createStatCard(String title, String value, Color color) {
        ...
        card.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(color.darker(), 2), // Border
