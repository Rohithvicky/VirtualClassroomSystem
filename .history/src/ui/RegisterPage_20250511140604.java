...
public class RegisterPage extends JFrame {
  ...
  public RegisterPage() {
    ...
    // Row for Show Password checkbox
    gbc.gridx = 0;
    gbc.gridy++;
    gbc.gridwidth = 2;
    ...
    // Row for Create Account button with blue background
    gbc.gridy++;
    JButton registerButton = new JButton("Create Account");
    registerButton.setFont(new Font("Segoe UI", Font.BOLD, 16));
    registerButton.setBackground(new Color(41, 128, 185)); // blue color
