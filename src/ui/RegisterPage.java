...
public class RegisterPage extends JFrame {
  ...
  public RegisterPage() {
    ...
    // Username Field directly aside the label (same insets)
    gbc.gridx = 1;
    ...
    // Password Field directly aside the label (same insets)
    gbc.gridx = 1;
    ...
    // Add the header, form and footer panels to the main panel
